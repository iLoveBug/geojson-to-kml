import { tag, encode } from "../lib/strxml";

export function root(_, options) {
  if (!_.type) return "";
...
export function documentDescription(options) {
...
var geometry = {
  Point: function (_) {
    // const coordinates = _.coordinates.length === 2 : [..._.coordinates, 50] : _.coordinates
    var coordinates = _.coordinates
